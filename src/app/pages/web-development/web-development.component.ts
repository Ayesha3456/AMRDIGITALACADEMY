  ...
  services = [
    {
      ...
      desc: 'Professional websites for your brand'
    },
    {
    ...
    },
    {
      ...
      iconClass: 'icon-sky',
      title: 'Landing Pages',
      desc: 'High-converting simple pages'
    }
  ];
  ...
  steps = [
    {
      ...
      title: 'Discuss',
      desc: 'Understand your requirement'
    },
    {
      num: '02',
      icon: 'bi-palette-fill',
      title: 'Design',
      desc: 'Create clean layout'
    },
    {
      num: '03',
      icon: 'bi-code-slash',
